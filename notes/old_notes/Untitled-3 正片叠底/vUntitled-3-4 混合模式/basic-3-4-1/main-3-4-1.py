...
def main():
    ...
    # 绘制45度水印线
    draw_watermark_lines(image, angle=45, color=color, shadow_color=shadow_color, spacing=spacing, emboss=True, line_width=line_width)  # 白色半透明
    ...
    draw_watermark_lines(image, angle=135, color=color, shadow_color=(255, 255, 255, shadow_opacity), dash_length=dash_length,spacing=spacing, emboss=True, line_width=line_width)  # 白色半透明
